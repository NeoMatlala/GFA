<template>
    <div class="p-3 text-white bg-[#1c2434] h-full border-r-[1px] border-slate-100">
        <div class="mb-24 ml-7 mt-3 font-medium text-3xl flex justify-start items-center gap-x-3">
        ...
        <p class="text-slate-400 px-7 mb-2 text-sm">MENU</p>
        <ul class="px-2 space-y-1">
            <li class="hover:bg-slate-700 p-2 pl-5 rounded-sm relative" :class="{ 'bg-slate-700': $route.path === '/dashboard' }">
                <NuxtLink to="/dashboard" class="flex justify-start text-slate-200 items-center gap-x-3">
                    <svg
                    class="fill-current"
                    width="18"
                    height="18"
            ...
            <li class="hover:bg-slate-700 p-2 pl-5 rounded-sm relative" :class="{ 'bg-slate-700': $route.path === '/contacts' }">
                <NuxtLink to="/contacts" class="flex justify-start text-slate-200 items-center gap-x-3">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-person-lines w-5" viewBox="0 0 16 16">
            ...
            <li class="hover:bg-slate-700 p-2 pl-5 rounded-sm relative" :class="{ 'bg-slate-700': $route.path === '/messages' }">
                <NuxtLink to="/messages" class="flex justify-start text-slate-200 items-center gap-x-3">
                    ...
                    <div class="flex w-full justify-between items-center">
                        ...
                        <span class="inline-flex items-center justify-center w-4 h-4 ms-2 text-xs font-semibold text-blue-800 bg-blue-200 rounded-full">{{ messageCount }}</span>
                    </div>
